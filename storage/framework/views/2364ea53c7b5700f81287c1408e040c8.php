            ...
            <div class="card bg-base-100 shadow-sm hover:shadow-md transition-shadow">
                ...
                <div class="card-body p-4">
                    ...
                    <div class="flex items-center gap-1 text-sm text-base-content/60">
                        ...
                        <?php echo e(ucfirst($property->city)); ?>

                        <span class="mx-1">·</span>
                        <?php echo e(ucfirst($property->type)); ?> · <?php echo e(ucfirst($property->status)); ?>

                    </div>
                    <div class="flex items-center justify-between mt-2">
                        <span class="text-xl font-bold text-primary">Ksh <?php echo e(number_format($property->price)); ?></span>
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
            ...
            <div class="card bg-base-100 shadow-sm text-center">
                <div class="card-body items-center gap-3">
                    ...
                    <p class="text-sm text-base-content/70 italic">"<?php echo e($testimonial->testimonial); ?>"</p>
            ...
            <div class="card bg-base-100 shadow-sm hover:shadow-md transition-shadow">
                ...
                <div class="card-body p-4">
                    ...
                    <div class="flex items-center gap-2 mt-2 text-xs text-base-content/50">
                        ...
                        <a href="<?php echo e(route('blog.author', $post->user->username)); ?>" class="hover:text-primary">
...
<?php echo $__env->make('frontend.layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\Admin\Desktop\RealEstate\resources\views/frontend/index.blade.php ENDPATH**/ ?>