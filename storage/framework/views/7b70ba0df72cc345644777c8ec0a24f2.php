                ...
                <div class="card bg-base-100 shadow-sm">
                    <div class="card-body gap-4">
                        <div class="flex items-center justify-between">
                            ...
                            <a href="<?php echo e(route('user.message')); ?>" class="btn btn-outline btn-sm gap-1">
                                <span class="material-icons text-sm">arrow_back</span> Back
                            </a>
                        </div>

                        <?php if($message->user_id): ?>
                        <form action="<?php echo e(route('user.message.send')); ?>" method="POST" class="flex flex-col gap-4">
                            <?php echo csrf_field(); ?>
                            ...
                            <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                                <fieldset class="fieldset">
                                    ...
                                    <input type="email" value="<?php echo e($message->email); ?>" class="input w-full bg-base-200" readonly>
                                </fieldset>
                                <fieldset class="fieldset">
...
<?php echo $__env->make('frontend.layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\projo\RealEstate-1\resources\views\user\messages\replay.blade.php ENDPATH**/ ?>