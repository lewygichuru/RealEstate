            ...
            <div>
                ...
                <p class="text-base-content/70 text-sm leading-relaxed">
                    <?php if(isset($footersettings[0]) && $footersettings[0]['aboutus']): ?>
                        <?php echo e($footersettings[0]['aboutus']); ?>
        ...
        <div class="container mx-auto px-4 py-3 flex flex-wrap items-center justify-between gap-2 text-sm text-base-content/70">
            ...
            <div class="flex gap-3">
                <?php if(isset($footersettings[0]) && $footersettings[0]['facebook']): ?>
                    <a href="<?php echo e($footersettings[0]['facebook']); ?>" target="_blank" class="hover:text-primary transition-colors font-medium">Facebook</a>
                <?php endif; ?>
                <?php if(isset($footersettings[0]) && $footersettings[0]['twitter']): ?>
                    <a href="<?php echo e($footersettings[0]['twitter']); ?>" target="_blank" class="hover:text-primary transition-colors font-medium">Twitter</a>
                <?php endif; ?>
                <?php if(isset($footersettings[0]) && $footersettings[0]['linkedin']): ?>
                    <a href="<?php echo e($footersettings[0]['linkedin']); ?>" target="_blank" class="hover:text-primary transition-colors font-medium">LinkedIn</a>
                <?php endif; ?>
            </div>
        </div>
    </div>
</footer>
<?php /**PATH C:\Users\Admin\Desktop\RealEstate\resources\views/frontend/partials/footer.blade.php ENDPATH**/ ?>