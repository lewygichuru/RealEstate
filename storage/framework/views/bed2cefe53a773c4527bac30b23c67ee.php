...
<div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
    ...
    <fieldset class="fieldset">
        ...
        <input type="text" name="latitude" class="input w-full" value="<?php echo e(old('latitude', $property?->latitude ?? '-1.286389')); ?>" id="latitude">
    </fieldset>
    <fieldset class="fieldset">
        <legend class="fieldset-legend">Longitude</legend>
        <input type="text" name="longitude" class="input w-full" value="<?php echo e(old('longitude', $property?->longitude ?? '36.817223')); ?>" id="longitude">
    </fieldset>
</div>
