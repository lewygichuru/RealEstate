                ...
                <div class="card bg-base-100 shadow-sm">
                    <div class="card-body gap-4">
                        ...
                        <div class="flex items-center gap-3 flex-wrap">
                            <a href="<?php echo e(route('user.message.replay', $message->id)); ?>" class="btn btn-primary btn-sm gap-1">
                                <span class="material-icons text-sm">reply</span> Reply
                            </a>
                            <form action="<?php echo e(route('user.message.readunread')); ?>" method="POST">
                                <?php echo csrf_field(); ?>
...
<?php echo $__env->make('frontend.layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\projo\RealEstate-1\resources\views\user\messages\read.blade.php ENDPATH**/ ?>