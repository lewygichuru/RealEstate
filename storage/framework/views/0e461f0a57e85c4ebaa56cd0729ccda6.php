                ...
                <div class="card bg-base-100 shadow-sm">
                    <div class="card-body gap-4">
                        ...
                        <form id="contact-us" action="" method="POST" class="flex flex-col gap-4">
                            <?php echo csrf_field(); ?>
                            <input type="hidden" name="mailto" value="<?php echo e($footersettings[0]['email'] ?? ''); ?>">
            ...
            <aside>
                <div class="card bg-base-100 shadow-sm sticky top-20">
                    <div class="card-body gap-6">
                        ...
                        <?php if(isset($footersettings[0]) && !empty($footersettings[0]['phone'])): ?>
                        <div class="flex items-start gap-3">
                            ...
                            <div>
                                ...
                                <p class="font-semibold"><?php echo e($footersettings[0]['phone']); ?></p>
                            </div>
                        </div>
                        <?php endif; ?>

                        <?php if(isset($footersettings[0]) && !empty($footersettings[0]['email'])): ?>
                        <div class="flex items-start gap-3">
                            ...
                            <div>
                                ...
                                <p class="font-semibold"><?php echo e($footersettings[0]['email']); ?></p>
                            </div>
                        </div>
                        <?php endif; ?>

                        <?php if(isset($footersettings[0]) && !empty($footersettings[0]['address'])): ?>
                        <div class="flex items-start gap-3">
                            ...
                            <div>
                                ...
                                <p class="font-semibold"><?php echo $footersettings[0]['address']; ?></p>
                            </div>
                        </div>
                        <?php endif; ?>
                    </div>
...
<?php echo $__env->make('frontend.layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\Admin\Desktop\RealEstate\resources\views/pages/contact.blade.php ENDPATH**/ ?>