        ...
        <div class="card bg-base-100 shadow-sm">
            <div class="card-body gap-4">
                ...
                <fieldset class="fieldset"><legend class="fieldset-legend">Description</legend>
                    <textarea name="description" id="tinymce" rows="8" class="textarea w-full"><?php echo e(old('description')); ?></textarea>
                </fieldset>
...
<?php echo $__env->make('backend.layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\projo\RealEstate-1\resources\views/admin/properties/create.blade.php ENDPATH**/ ?>