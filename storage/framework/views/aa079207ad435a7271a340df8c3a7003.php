        ...
        <div class="max-w-md mx-auto">
            <div class="card bg-base-100 shadow-sm">
                <div class="card-body gap-4">
                    <h1 class="card-title text-2xl justify-center"><?php echo e(__('Create Account')); ?></h1>

                    <form method="POST" action="<?php echo e(route('register')); ?>" class="flex flex-col gap-4">
                        <?php echo csrf_field(); ?>

                        <fieldset class="fieldset">
                            <legend class="fieldset-legend"><?php echo e(__('Full Name')); ?></legend>
                            <input id="name" type="text" name="name" value="<?php echo e(old('name')); ?>"
                                   class="input w-full <?php echo e($errors->has('name') ? 'input-error' : ''); ?>"
                                   required autofocus>
                            <?php if($errors->has('name')): ?>
                                <p class="fieldset-label text-error"><?php echo e($errors->first('name')); ?></p>
                            <?php endif; ?>
                        </fieldset>
                        ...
                        <label class="flex items-center gap-3 cursor-pointer">
                            ...
                            <span class="text-sm"><?php echo e(__('Register as Agent')); ?></span>
                        </label>

                        <button type="submit" class="btn btn-primary w-full mt-1"><?php echo e(__('Register')); ?></button>

                        <div class="divider text-xs my-0">Already have an account?</div>
                        <a href="<?php echo e(route('login')); ?>" class="btn btn-outline btn-sm w-full"><?php echo e(__('Login')); ?></a>
                    </form>
                </div>
            </div>
        </div>
...
<?php echo $__env->make('frontend.layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\Admin\Desktop\RealEstate\resources\views/auth/register.blade.php ENDPATH**/ ?>