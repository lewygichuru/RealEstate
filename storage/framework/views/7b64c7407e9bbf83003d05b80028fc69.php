            ...
            <div class="lg:col-span-3">
                <div class="card bg-base-100 shadow-sm">
                    <div class="card-body gap-4">
                        ...
                        <form action="<?php echo e(route('agent.properties.update', $property->id)); ?>" method="POST" enctype="multipart/form-data" class="flex flex-col gap-4">
                            <?php echo csrf_field(); ?>
                            <?php echo method_field('PUT'); ?>

                            <fieldset class="fieldset">
                                <legend class="fieldset-legend">Title</legend>
                                <input type="text" name="title" value="<?php echo e(old('title', $property->title)); ?>" class="input w-full" maxlength="200" required>
                            </fieldset>

                            <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                                <fieldset class="fieldset">
                                    <legend class="fieldset-legend">Type</legend>
                                    <input type="text" name="type" value="<?php echo e(old('type', $property->type)); ?>" class="input w-full" required>
                                </fieldset>
                                <fieldset class="fieldset">
                            ...
                            <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                                <fieldset class="fieldset">
                                    ...
                                    <input type="number" name="price" value="<?php echo e(old('price', $property->price)); ?>" class="input w-full" required>
                                </fieldset>
                            ...
                            <fieldset class="fieldset">
                                ...
                                <textarea name="description" rows="5" class="textarea w-full" required><?php echo e(old('description', $property->description)); ?></textarea>
                            </fieldset>

                            <div class="flex items-center gap-2">
                                <input type="checkbox" name="is_featured" value="1" class="checkbox checkbox-primary" <?php if(old('is_featured', $property->is_featured)): echo 'checked'; endif; ?>>
                            ...
                            <div>
                                ...
                                <div class="grid grid-cols-2 sm:grid-cols-4 gap-3">
                                    ...
                                    <img class="w-full h-24 object-cover rounded-box" src="<?php echo e($gallery->file_path); ?>" alt="<?php echo e($gallery->file_name); ?>">
...
<?php echo $__env->make('frontend.layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\projo\RealEstate-1\resources\views\agent\properties\edit.blade.php ENDPATH**/ ?>