                                        ...
                                        <td>
                                            <div class="flex gap-1">
                                                <?php if($message->status == 0): ?>
                                                    <a href="<?php echo e(route('user.message.read', $message->id)); ?>" class="btn btn-warning btn-xs" title="Unread"><span class="material-icons text-sm">local_library</span></a>
                                                <?php else: ?>
                                                    <a href="<?php echo e(route('user.message.read', $message->id)); ?>" class="btn btn-success btn-xs" title="Read"><span class="material-icons text-sm">done</span></a>
                                                <?php endif; ?>
                                                <a href="<?php echo e(route('user.message.replay', $message->id)); ?>" class="btn btn-primary btn-xs" title="Reply"><span class="material-icons text-sm">reply</span></a>
                                                ...
                                                <form action="<?php echo e(route('user.messages.destroy', $message->id)); ?>" method="POST" id="del-message-<?php echo e($message->id); ?>" class="hidden">
...
<?php echo $__env->make('frontend.layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\projo\RealEstate-1\resources\views/user/messages/index.blade.php ENDPATH**/ ?>