    ...
    <div class="container mx-auto px-4 w-full flex items-center">
        ...
        <div class="flex-1">
            <a href="<?php echo e(route('home')); ?>" class="btn btn-ghost text-xl font-bold gap-1">
                ...
                <?php if(isset($footersettings[0]) && $footersettings[0]['name']): ?>
                    <?php echo e($footersettings[0]['name']); ?>
...
<?php /**PATH C:\Users\Admin\Desktop\RealEstate\resources\views/frontend/partials/navbar.blade.php ENDPATH**/ ?>