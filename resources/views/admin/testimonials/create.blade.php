...
<div class="card bg-base-100 shadow-sm max-w-xl">
    <div class="card-body gap-4">
        ...
        <form action="{{ route('admin.testimonials.store') }}" method="POST" enctype="multipart/form-data" class="flex flex-col gap-4">
            @csrf
            ...
            <fieldset class="fieldset">
                ...
                <textarea name="testimonial" rows="4" class="textarea w-full"></textarea>
            </fieldset>
            <fieldset class="fieldset">
